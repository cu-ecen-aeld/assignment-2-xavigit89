...
void test_validate_my_username()
{
   ...
   char *from_config_username = malloc_username_from_conf_file();
   TEST_ASSERT_EQUAL_STRING_MESSAGE(hard_coded_username, from_config_username, "Mismatch");
   free(from_config_username);
}
